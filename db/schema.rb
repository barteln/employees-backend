...
ActiveRecord::Schema.define(version: 20170205193025) do
  ...
  create_table "employees", primary_key: "emp_no", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
